/*
 * resepServer - https://github.com//resep-server.git
 *
 * Copyright (c) 2018 
 */
 ...
 * @requires express
 * @requires q
 * @requires module:b/info
 * @requires module:b/config-util
 * @requires module:b/logger
 * @requires module:b/middleware
 * @requires module:b/router/mysql
 */
...
const logger          = require('app/logger').getLogger('b');
